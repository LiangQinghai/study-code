...
<head>
    ...
    <link rel="stylesheet" href="${rc.contextPath}/static/css/admin/AdminLTE.min.css"/>
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link rel="stylesheet" href="${rc.contextPath}/static/css/admin/all-skins.min.css"/>
    <link rel="stylesheet" href="${rc.contextPath}/static/css/admin/main.css"/>
