...
<link rel="stylesheet" href="${rc.contextPath}/static/common/ztree/css/metroStyle/metroStyle.css">
<script src="${rc.contextPath}/static/common/ztree/js/jquery.ztree.all.min.js"></script>
...
<!-- 自定义js -->
<script src="${rc.contextPath}/static/js/admin/sys/menu.js"></script>
[#-- 页面加载进度条 --]
