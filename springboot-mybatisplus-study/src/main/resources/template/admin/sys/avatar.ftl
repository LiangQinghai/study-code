...
<head>
    ...
    <link href="${rc.contextPath}/static/common/bootstrap-fileinput/css/fileinput.css" media="all" rel="stylesheet"
          type="text/css">
    <link href="${rc.contextPath}/static/common/bootstrap-fileinput/themes/explorer/theme.css" media="all" rel="stylesheet"
          type="text/css">
    <style>
...
<script src="${rc.contextPath}/static/common/bootstrap-fileinput/js/plugins/sortable.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-fileinput/js/fileinput.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-fileinput/themes/explorer/theme.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-fileinput/js/locales/zh.js"></script>
<script>
