...
<head>
    ...
    <link rel="stylesheet" href="${rc.contextPath}/static/common/bootstrap-table/bootstrap-table.min.css"/>
    <link rel="stylesheet" href="${rc.contextPath}/static/common/icheck/flat/green.css"/>
    <link rel="stylesheet" href="${rc.contextPath}/static/common/bootstrap-switch/css/bootstrap-switch.min.css"/>
</head>
...
<script src="${rc.contextPath}/static/common/bootstrapvalidator/js/bootstrapValidator.min.js"></script>
<!-- Bootstrap table -->
<script src="${rc.contextPath}/static/common/bootstrap-table/bootstrap-table.min.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-table/extensions/export/bootstrap-table-export.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-table/tableExport.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"></script>
<!-- 自定义js -->
<script src="${rc.contextPath}/static/js/admin/sys/admin.js"></script>
<!-- iCheck -->
<script src="${rc.contextPath}/static/common/icheck/icheck.min.js"></script>
<script src="${rc.contextPath}/static/common/bootstrap-switch/js/bootstrap-switch.min.js"></script>
[#-- 邮箱自动补全 --]
