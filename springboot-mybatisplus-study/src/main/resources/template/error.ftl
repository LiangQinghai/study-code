...
<head lang="zh-CN">
    ...
    <link rel="stylesheet" href="${rc.contextPath}/static/common/error/css/main.css"/>
    <!-- main stylesheet -->
    <link rel="stylesheet" href="${rc.contextPath}/static/common/error/css/tipsy.css"/>
    <!-- Tipsy implementation -->
    <script src="${rc.contextPath}/static/common/error/scripts/jquery-1.7.2.min.js"></script>
    <!-- uiToTop implementation -->
    <script src="${rc.contextPath}/static/common/error/scripts/custom-scripts.js"></script>
    <script src="${rc.contextPath}/static/common/error/scripts/jquery.tipsy.js"></script>
    <!-- Tipsy -->
    <script>
...
<div id="universal-preloader">
    <div class="preloader">
        <img src="${rc.contextPath}/static/common/error/images/universal-preloader.gif" alt="universal-preloader"
        ...
        <div class="bubble-options">
            ...
            <p class="dog-bubble">
                I wish I had a cookie<br/><img style="margin-top:8px"
                                               src="${rc.contextPath}/static/common/error/images/cookie.png"
                                               alt="cookie"/>
            </p>
            ...
            <p class="dog-bubble">
                I think I saw a <br/><img style="margin-top:8px"
                                          src="${rc.contextPath}/static/common/error/images/cat.png" alt="cat"/>
            </p>
